...
<div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 w-full">
    ...
    <form method="POST" action="{{ route('admin.videos.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="rounded-2xl border border-gray-100 bg-gray-50/80 p-5">
            ...
            <div>
                ...
                <div>
                    ...
                    <input name="max_watches_per_day" type="number" min="1" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Default 1 watch / user">
                </div>
        ...
        <div class="rounded-2xl border border-gray-100 p-5">
            ...
            <textarea name="description" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Optional but recommended for community videos.">{{ old('description') }}</textarea>
        </div>
