...
<head>
    ...
    <title>New Deposit Request - Earn Quest</title>
</head>
                ...
                <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px 20px; text-align: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px 10px 0 0;">
                            ...
                            <p style="margin: 10px 0 0; color: #ffffff; font-size: 16px; opacity: 0.9;">New Deposit Request</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 30px; color: #333333; font-size: 16px; line-height: 1.6;">
                                A new deposit request has been submitted and requires your review.
                            </p>
                            ...
                            <div style="background: #f8f9fa; padding: 25px; border-radius: 10px; border-left: 4px solid #667eea; margin: 20px 0;">
                                <h3 style="margin: 0 0 15px; color: #333333; font-size: 18px; font-weight: bold;">Deposit Details</h3>
                                <table role="presentation" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 0; text-align: right; color: #333333;">{{ $packageName }}</td>
                                    </tr>
                                    @if($transactionId)
                                    <tr>
                                        <td style="padding: 8px 0; color: #666666; font-weight: 600;">Transaction ID:</td>
                                        <td style="padding: 8px 0; text-align: right; font-family: monospace; font-size: 12px; color: #333333;">{{ $transactionId }}</td>
                                    </tr>
                                    @endif
                                    @if($walletAddress)
                                    <tr>
                                        <td style="padding: 8px 0; color: #666666; font-weight: 600;">Wallet:</td>
                            ...
                            <div style="background: #fff3cd; border: 1px solid #ffc107; border-radius: 8px; padding: 15px; margin: 20px 0;">
                                <p style="margin: 0; color: #856404; font-size: 14px; line-height: 1.6;">
                                    <strong>Action Required:</strong> Please review this deposit request in the admin panel and verify the payment before approving.
                                </p>
                            </div>
                            
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{ route('admin.deposits') }}" style="display: inline-block; padding: 12px 30px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px;">
